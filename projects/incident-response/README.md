### Incident Response – Integration Failure
A case study applying the NIST SP 800-61 incident-response lifecycle to a system integration failure, where purchase-order messages failed to transmit between an
internal system and external vendors.
