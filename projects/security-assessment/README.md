### Security Assessment – Small Enterprise Environment
A structured, risk-based security assessment of a small business (25 staff, cloud email, shared storage, no dedicated security team), identifying key risks and proportionate controls.

#### What it demonstrates

- Asset identification and a risk-based assessment approach
- Scoring risks on likelihood × impact (Low/Medium/High/Critical), with the rationale behind each rating — not just the score
