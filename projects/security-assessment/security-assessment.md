...
Prioritising the two Critical risks (MFA and phishing awareness), followed by access control and endpoint hardening, would significantly reduce the organisation's exposure for relatively low cost. 
